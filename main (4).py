...
def init_db():
    ...
    cursor.execute('''
        CREATE TABLE IF NOT EXISTS admin_settings (
            ...
            channel_1 TEXT DEFAULT '@osintbyrockey',
            channel_2 TEXT DEFAULT '@Rockeyinfbot',
    ...
    cursor.execute('''
        ...
        VALUES (5768665344, 'kalibomb1', TRUE, TRUE, 5768665344)
    ''')
...
ADMIN_USER_ID = 5768665344  # Default/Owner admin
BOT_OWNER_ID = 5768665344   # Bot owner - cannot be removed
BOT_OWNER_USERNAME = "kalibomb1"  # Owner username for contact
...
class ProfessionalAPITelegramBot:
    ...
    async def show_channel_verification(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        keyboard = [
            [InlineKeyboardButton("📢 Channel 1 Join Karo", url="https://t.me/osintbyrockey")],
            [InlineKeyboardButton("📢 Channel 2 Join Karo", url="https://t.me/backuprockey4")],
            [InlineKeyboardButton("✅ Verify Subscription", callback_data="verify_channels")]
        ]
        reply_markup = InlineKeyboardMarkup(keyboard)
        
        welcome_text = """
🤖 **Welcome to ROCKEY INFO BOT!**
...
• View your statistics
    ...
    async def admin_change_channels(self, query, context: ContextTypes.DEFAULT_TYPE):
        ...
        await query.edit_message_text(
            ...
            "`channel1 channel2`\n\n"
            "Example: `@innocyber130 @innobomber_bot`\n\n"
            "Or send /cancel to cancel this operation.",
            parse_mode='Markdown'
        )
...
• Growth Today: `{new_users_today} users`
    ...
    async def handle_pak_bomber(self, args, user_id: int = None):
        ...
        try:
            api_url = f"https://username-brzb.vercel.app"
            response = requests.get(api_url, timeout=30)
...
💡 For support, contact admin via @kalibomb1"""
